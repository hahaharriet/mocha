    	...
    	<div class="container-fluid"> 
    		<div class="row">
    			...
    			<div class="col-sm col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="product_detail_cust_m?productno=${product.productno}" class="img-prod"><img class="img-fluid" src="filemanager/${product.imgname}"alt="Colorlib Template">
          ...
          <div class="col text-center">
            <div class="block-27">
              ...
              <c:if test="${pageGroupResult.beforePage}">
                <li><a href="product_req_list?reqPage=${pageGroupResult.groupStartNumber-1}">&lt;</a></li>
                </c:if>
     <c:forEach var="index" begin="${pageGroupResult.groupStartNumber}" end="${pageGroupResult.groupEndNumber}">
	<c:choose>
			<c:when test="${pageGroupResult.selectPageNumber==index}">
		  <li class="active">		<span id="select"><a href="product_req_list?reqPage=${index}">${index}</a></span></li>		
			</c:when>
			<c:otherwise>
                ...
                <li><a href="product_req_list?reqPage=${pageGroupResult.groupEndNumber+1}">&gt;</a></li>
                </c:if>
              </ul>
            </div>
          </div>
