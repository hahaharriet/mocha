		...
		<section class="ftco-section ftco-cart">
			<div class="container">
				...
				<table>
					...
					<tr>
						<td colspan="2" style="text-align:right"><input type="submit" class="btn btn-primary login-btn btn-block" value ="Confirm"></td>
					</tr>
				</table>
				</form>
				</div>
  ...
  <script src="js/main.js"></script>
	...
	$("#update").validate({
		...
		messages : {
			...
			repassword :{
				required :"Please enter your PIN number.",
				equalTo :"Password verification is invalid."
			}
		}
	});
});
