      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
                ...
                <h3 class="mb-5">Customer Delete</h3>
                <form action="member_delete.do" class="p-5 bg-light" method="post" id="form">
                  ...
                  <div class="form-group">
                    <label for="email">Pass Word *</label>
                  ...
                  <div class="form-group">
                    <input type="button"  id="delete" value="Membership Withdrawal" class="btn py-3 px-4 btn-primary">
                  </div>
                </form>
              </div>
...
$(function(){
	...
	$(function(){
		$("#delete").click(function(){
			var con= confirm("Are you sure you want to leave?");
			if(con==true){
