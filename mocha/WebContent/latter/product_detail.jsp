...
<script>
	function deleteProduct() {
		location.href = "review_delete?reviewno=${review.reviewno}";
		return false;
	}
</script>
</head>
		...
		<div class="container">
			<div class="row block-9">
				<c:if test="${review.review_memberid == member.memberid}">
					<form action="review_update?reviewno=${review.reviewno}"
						method="post" id="signupForm1" class="bg-white p-5 contact-form">
						<div class="form-group">
							<label>Writer</label> <input type="text" class="form-control"
								name="review_memberid" value="${review.review_memberid}"
								disabled="disabled"> <input type="hidden"
								class="form-control" name="review_memberid"
								value="${review.review_memberid}">
						</div>

						<div class="form-group">
							<label>Title</label> <input name="reviewsubject"
								id="reviewsubject" value="${review.reviewsubject}"
								class="form-control" />
						</div>
						<div class="form-group">
							<label>Content</label>
							<textarea name="content" id="" cols="30" rows="7"
								class="form-control" id="content">${review.content}</textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="button" value="Delete"
								class="btn btn-primary py-3 px-5" style="float: left;"
								onclick="deleteProduct()">&nbsp; <input type="button"
