			...
			<table class="table table-bordered table-hover" style="text-align:left;"  >		
				<tbody>		
					<tr>
						...
						<input type="text" name ="eventsubject" size=25	placeholder="제목을 입력해주세요"/><br /></td>
					</tr>
					<tr>
						<td ><strong>이벤트 기간:&nbsp;&nbsp;</strong><input type="date" name="start_date" />
							~<input type="date" name="end_date" /></td>
					</tr>
					<tr>
						<td >
							<strong>writer</strong>
							<textarea class="form-control" name = "eventcontent" rows="15" placeholder="내용을 입력해주세요"></textarea><br />
						</td>
					</tr>					
					<tr>	
