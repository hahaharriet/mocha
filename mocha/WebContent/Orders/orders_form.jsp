      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">Home</a></span><a href="Orders_list">Order List</a></p>
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="w-100"></div>
		            ...
		            <div class="col-6">
		            	<div class="form-group">
		            		...
		            		<input type="text" name="productname" class="form-control"  value="${product.productname}" readonly="readonly"/><br />
		            	</div>
		            </div>
		            ...
		            <div class="col-6">
	                	...
	                	<label for="streetaddress">Postcode / ZIP *</label>
	                  
	                  <input type="text" class="form-control" id="sample4_postcode" name="postnum" placeholder="우편번호"><br />
	                  
	                  <input type="button" class="btn btn-primary py-1 px-2" id="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br />
		          ...
		          <br />
		            ...
		            <div class="col-md-12">
		            	<div class="form-group">
	                	<label for="towncity">Street Address</label>
	                  <input type="text" class="form-control" id="sample4_roadAddress" name="roadaddress" placeholder="도로명주소"><br />
	                </div>
		            </div>
		            <div class="col-md-12">
		            	<div class="form-group">
		            		<label for="postcodezip">Land-Lot</label>
	                 	<input type="text" class="form-control" id="sample4_jibunAddress" name="landrotaddress" placeholder="지번주소"><br />
		            ...
		            <div class="col-md-6">
	                <div class="form-group">
	                	<label for="phone">Details Address</label>
	                  <input type="text" class="form-control" id="sample4_detailAddress" name="detailsaddress" placeholder="상세주소">
	                </div>
	              </div>
	               ...
	               <div class="w-100"></div>
		            <div class="col-md-6">
	                <div class="form-group">
	                	<label for="phone">See Also</label>
	                  <input type="text" class="form-control" id="sample4_extraAddress" name="seealso" placeholder="참고항목"><br />
	                </div>
	              </div>
		    					...
		    					<p class="d-flex total-price">
		    						...
		    						<input
		    						 style="border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;"
		    						  name="ordersprice"  value="${product.price}" readonly="readonly"/>￥
	          		...
	          		<div class="cart-detail bg-light p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									...
									<div  class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2" /> Paypal</label><br /> <label class="error" for="optradio"></label>
											</div>
										</div>
									</div>
									<input class="btn btn-primary py-3 px-4" type="submit" id="payment" value="결제하기"/>
